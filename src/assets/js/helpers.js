export default {
  ...
  getIceServer() {
    return {
      iceServers: [
        ...
        {
          username:
            "ObOBGFMWjiqjCY_UT636JG7tHUpL0OsaXlfivsniaWOcDpoA8pUbZ2xBlzNXMWnYAAAAAGLcA01zYWJiaXJ4Y29kZQ==",
          credential: "6166e198-0a92-11ed-a3e8-0242ac140004",
          urls: [
  ...
  adjustVideoElemSize() {
    ...
    for (let i = 0; i < totalRemoteVideosDesktop; i++) {
      elem[i].style.width = `calc(${newWidth} - 20px)`;
      console.log(`calc(${newWidth} - 20px)`)
    }
  },
